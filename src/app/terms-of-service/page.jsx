    ...
    <div className="flex flex-col items-center justify-start bg-white w-full text-black py-16">
      <div className="bg-white p-8 sm:p-12 md:p-16 flex flex-col items-center w-full max-w-2xl lg:max-w-3xl text-left">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          This website is operated by Tarakaya Silver OPC private Limited. Throughout the site, the terms “we”, “us” and “our” refer to Tarakaya Silver. Tarakaya Silver offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
        </p>
        <p className="text-gray-700 leading-relaxed mb-4">
        ...
        <p className="text-gray-700 leading-relaxed mb-8">
          You agree to indemnify, defend and hold harmless Tarakaya Silver and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, Service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
        </p>
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          Questions about the Terms of Service should be sent to us at <a href="mailto:tarakayasilver@gmail.com" className="text-blue-600 hover:underline">tarakayasilver@gmail.com</a>.
        </p>
        <p className="text-gray-700 leading-relaxed mb-2">
          Our contact information is posted below:
        </p>
        <ul className="list-disc pl-6 text-gray-700 leading-relaxed mb-8">
          <li className="mb-2"><strong>Trade name:</strong> Tarakaya Silver (OPC) private limited</li>
